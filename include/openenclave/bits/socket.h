...
#elif !defined(OE_NO_POSIX_SOCKET_API)
#define gethostname(name, len) oe_gethostname(OE_NETWORK_UNTRUSTED, name, len)
#endif
...
#define getnameinfo(sa, salen, host, hostlen, serv, servlen, flags) \
    oe_getnameinfo(                                                 \
        OE_NETWORK_UNTRUSTED, sa, salen, host, hostlen, serv, servlen, flags)
#endif
...
#elif !defined(OE_NO_POSIX_SOCKET_API)
#define WSACleanup() oe_wsa_cleanup(OE_NETWORK_UNTRUSTED)
#endif
...
#elif !defined(OE_NO_POSIX_SOCKET_API)
#define WSAGetLastError() oe_wsa_get_last_error(OE_NETWORK_UNTRUSTED)
#endif
